...
sed -i "s#<hostName>xxx.xxx.xx</hostName>#<hostName>$ACTUAL_WK_MEMBER_HOST</hostName>#" /wso2home/wso2es-2.1.0-beta/repository/conf/axis2/axis2.xml
...
sed -i "s#\"identityProviderURL\": \"https://xxx.xxx.xx/samlsso\"#\"identityProviderURL\": \"https://$IS_PORT_9443_TCP_ADDR:9443/samlsso\"#" /wso2home/wso2es-2.1.0-beta/repository/deployment/server/jaggeryapps/store/config/store.json
